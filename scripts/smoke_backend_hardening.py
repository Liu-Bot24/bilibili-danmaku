        ...
        json.dumps(
            {
                ...
                "fallback_order": ["example-openai-compatible"],
...
def assert_model_config_fallback() -> None:
    ...
    assert_true(runtime["active_provider"] == "example-openai-compatible", "invalid active provider should fall back")
    assert_true(runtime["fallback_order"][0] == "example-openai-compatible", "fallback order should start with valid fallback")
