...
DEFAULT_MODEL_PROVIDER = "openai-compatible-primary"
...
PRIMARY_ENDPOINT = os.getenv(
    "BILI_DANMAKU_PRIMARY_ENDPOINT",
    "https://api.example.com/v1/chat/completions",
)
SECONDARY_ENDPOINT = os.getenv(
    "BILI_DANMAKU_SECONDARY_ENDPOINT",
    "https://api2.example.com/v1/chat/completions",
)

MODEL_CONFIGS: dict[str, dict[str, Any]] = {
    "openai-compatible-primary": {
        "label": "Primary OpenAI-compatible model",
        "model": "provider/model-name",
        "endpoint": PRIMARY_ENDPOINT,
        "key_env": "BILI_DANMAKU_PRIMARY_API_KEY",
        ...
        "connect_timeout": 10,
        "read_timeout": 120,
        "request_deadline": 150,
        "max_retries": 0,
    },
    "openai-compatible-secondary": {
        "label": "Secondary OpenAI-compatible model",
        "model": "provider/backup-model-name",
        "endpoint": SECONDARY_ENDPOINT,
        "key_env": "BILI_DANMAKU_SECONDARY_API_KEY",
        "context_window": 128000,
        "max_prompt_chars": 100000,
        "max_tokens": 4000,
        "temperature": 0.8,
